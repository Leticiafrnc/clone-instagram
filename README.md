# Clone Instagram
 Esse projeto foi desenvolvido para aprendizado.
...
Clone este repositório usando git clone: https://github.com/Leticiafrnc/clone-instagram.git ou clique em Code/Download ZIP. Clique no arquivo "index.HTML" e veja a aplicação.
